...
* [LynxPrompt](https://github.com/GeiserX/LynxPrompt) — Self-hostable platform for generating and managing AI IDE config files like AGENTS.md, CLAUDE.md, .cursorrules, and 30+ other formats.
