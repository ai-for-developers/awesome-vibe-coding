...
* [Ordewell](https://github.com/ordewell/ordewell) — CLI/TUI that turns one goal into an ordered plan of coding-agent tasks (Claude Code, Codex, OpenCode), each with its own runner, model and mode.
